...
ScrollReveal().reveal('#paragraph-reveal, #name-reveal, #button-reveal', {delay:5, origin:'bottom', interval: 300});
ScrollReveal().reveal('#about-title, #about-description, #about-picture', {easing: 'cubic-bezier(0.5, 0, 0, 1)',  interval: 100});
